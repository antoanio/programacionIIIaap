...
namespace bicola
{
    class Program
    {
        ...
        public void Menu()
        {
            ...
            Console.WriteLine(" 1.Agregar por el frente  2.agregar por el final   3.eliminar por el frente   4.eliminar por el final 5.imprimir elementos  6.salir");
            ...
            switch (opc)
            {
                ...
                case 6: Console.WriteLine("finalizar"); break;
                default: Console.WriteLine("Seleccione una de las  opciones del menu"); break;
            }
        }
